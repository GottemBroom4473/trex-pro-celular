...
function setup() {
  ...
  fimDeJogo = createSprite(width/2,height/2+60);
  fimDeJogo.addImage(imgFimDeJogo);
  fimDeJogo.scale = 0.7;
  
  reiniciar = createSprite(width/2,height/2+140);
  ...
  soloInvisivel = createSprite(width/4,height-40, width,10);
...
function gerarNuvens() {
  ...
  if (frameCount % 60 === 0) {
    nuvem = createSprite(width,height-20,40,10);
    nuvem.y = Math.round(random(height/2,height-30));
